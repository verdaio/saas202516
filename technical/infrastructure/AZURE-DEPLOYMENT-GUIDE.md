...
1. Go to: `https://github.com/YOUR_ORG/saas202516/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202516/actions
```

**Staging will be live at:** `https://saas202516-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202516.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202516-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202516acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202516acr.azurecr.io`

### Container Apps Environment: `saas202516-env`
...
1. **saas202516-staging** (staging environment)
   - URL: `https://saas202516-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202516-prod** (production environment)
   - URL: `https://saas202516.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202516-db`
...
**Databases:**
- `saas202516_staging` - Staging environment
- `saas202516_production` - Production environment

### Redis Cache: `saas202516-redis`
...
### Blob Storage: `saas202516storage`
...
az keyvault secret show \
  --vault-name saas202516-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202516-db.postgres.database.azure.com:5432/saas202516_production?sslmode=require"
```
...
2. Find your Container App: `saas202516-prod`
...
az containerapp logs show \
  --name saas202516-staging \
  --resource-group saas202516-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202516-prod \
  --resource-group saas202516-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202516-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202516-rg/providers/Microsoft.App/containerApps/saas202516-prod \
...
```
https://github.com/YOUR_ORG/saas202516/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202516-rg/providers/Microsoft.App/containerApps/saas202516-prod \
...
az postgres flexible-server restore \
  --resource-group saas202516-rg \
  --name saas202516-db-restored \
  --source-server saas202516-db \
...
az containerapp revision activate \
  --name saas202516-prod \
  --resource-group saas202516-rg \
  --revision saas202516-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202516
