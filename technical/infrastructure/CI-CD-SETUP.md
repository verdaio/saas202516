...
az ad sp create-for-rbac \
  --name "saas202516-github-actions" \
  --role contributor \
  --scopes /subscriptions/{SUBSCRIPTION_ID}/resourceGroups/saas202516-rg \
  --sdk-auth
...
1. Go to: `https://github.com/YOUR_ORG/saas202516/settings/actions`
...
# Or use GitHub UI:
# https://github.com/YOUR_ORG/saas202516/releases/new
```
...
```markdown
![CI](https://github.com/YOUR_ORG/saas202516/workflows/CI/badge.svg)
![Deploy Staging](https://github.com/YOUR_ORG/saas202516/workflows/Deploy%20Staging/badge.svg)
![Deploy Production](https://github.com/YOUR_ORG/saas202516/workflows/Deploy%20Production/badge.svg)
```
...
2. Check Service Principal hasn't expired:
   ```bash
   az ad sp list --display-name "saas202516-github-actions"
   ```
...
# Test Docker build
docker build -t saas202516:test .
docker run -p 8000:8000 saas202516:test
```
