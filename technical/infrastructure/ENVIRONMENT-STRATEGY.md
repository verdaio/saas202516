...
| **URL** | localhost:3016 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5416/saas202516
REDIS_URL=redis://localhost:6416
FRONTEND_URL=http://localhost:3016
CORS_ORIGINS=http://localhost:3016
```
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202516-db.postgres.database.azure.com/saas202516_staging
REDIS_URL=rediss://saas202516-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202516-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202516-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202516-db.postgres.database.azure.com/saas202516_production
REDIS_URL=rediss://saas202516-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202516.azurecontainerapps.io
CORS_ORIGINS=https://saas202516.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202516-staging.azurecontainerapps.io npm run test:e2e
```
