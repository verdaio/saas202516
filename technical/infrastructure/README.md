...
This directory contains all infrastructure, deployment, and operations documentation for saas202516.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202516/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3016 | Manual |
| **Staging** | Testing/QA | saas202516-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202516.azurecontainerapps.io | On release tag |
